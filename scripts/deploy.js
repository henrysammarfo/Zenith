...
async function main() {
  ...
  console.log("ConfigManager deployed to:", await configManager.getAddress());
  ...
  console.log("Updating yield monitor with vault address...");
  await yieldMonitor.updateVaultAddress(await vault.getAddress());
  console.log("Yield monitor updated");
  
  // Update config manager with vault address
  console.log("Updating config manager with vault address...");
  await configManager.updateVaultAddress(await vault.getAddress());
  console.log("Config manager updated");
  
  // Mint and transfer tokens to deployer for testing
  ...
  console.log("Config Manager:", await configManager.getAddress());
